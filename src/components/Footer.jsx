        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-14">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              <a href="https://www.facebook.com/share/r/18D1c2SrDW/" target="_blank" rel="noreferrer" className="w-9 h-9 rounded bg-slate-900 hover:bg-[#f5a623] hover:text-black text-slate-400 flex items-center justify-center border border-slate-800 transition-colors" aria-label="Facebook">
          ...
          <div>
            ...
            <div className="space-y-4 text-sm text-slate-400">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+918882333651" className="hover:text-[#f5a623] font-semibold text-slate-200">
                  +91 88823 33651
                </a>
              </div>
              <div className="flex items-center gap-3">
                <Mail size={18} className="text-[#f5a623] shrink-0" />
                <a href="mailto:Vedreadymixconcrete@gmail.com" className="hover:text-[#f5a623]">
