...
export const FloatingCTAs = ({ onOpenLeadModal }) => {
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-3 pointer-events-auto">
      {/* WhatsApp Button */}
      <a
        href="https://wa.me/918882784781?text=Hello%20Mangalam%20Aerovista%2C%20I%20am%20interested%20in%20Dholera%20Smart%20City%20plots."
        target="_blank"
      ...
      >
        ...
        <span className="text-amber-400">+91 8882784781</span>
      </a>
    </div>
  );
};
